; Listing generated by Microsoft (R) Optimizing Compiler Version 19.32.31329.0 
	...
	TITLE	D:\ÄÚµù\Raven\Buckland_Chapter7 to 10_Raven\Debug\WindowUtils.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG164257 DB	'invalid argument', 00H
	ORG $+3
$SG164258 DB	'%s', 00H
	ORG $+1
$SG164259 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.32.31326\include\xmemory', 00H
	ORG $+2
$SG164261 DB	00H, 00H
	ORG $+2
$SG164260 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG164262 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG159058 DB	'Error', 00H
	ORG $+2
$SG159062 DB	'Error', 00H
	ORG $+2
$SG159161 DB	'*.*', 00H
$SG159162 DB	'All Files (*.*)', 00H
$SG159163 DB	'*.', 00H
CONST	ENDS
...
$LN7@Allocate_m:
	push	OFFSET $SG164257
	push	OFFSET $SG164258
	push	0
	push	135					; 00000087H
	push	OFFSET $SG164259
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG164260
	push	OFFSET $SG164261
	push	OFFSET $SG164262
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\ÄÚµù\Raven\Common\misc\Stream_Utility_Functions.h
...
; Function compile flags: /Odtp /RTCsu
; File D:\ÄÚµù\Raven\Common\misc\WindowUtils.cpp
_TEXT	SEGMENT
$T1 = -42						; size = 1
$T2 = -41						; size = 1
_s$ = -36						; size = 28
...
; 108  :   std::string filter = defaultFileTypeDescription + '\0' + "*." + defaultFileExtension + '\0' +
	...
	push	0
	push	OFFSET $SG159162
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG159163
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
